...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_wandb", type=str2bool,
                        default=True, help="log with wandb?")
    parser.add_argument(
    ...
    parser.add_argument("--jax_seed", type=int,
                        default=1919, help="seed randomness")
    ...
    parser.add_argument("--r_min", type=float, default=0.0,
                        help="|lambda|_min for LRU")
    parser.add_argument("--r_max", type=float, default=1.0,
                        help="|lambda|_max for LRU")
    ...
    parser.add_argument("--lr_factor", type=float, default=0.5,
                        help="ssm lr = lr_factor * lr_base")
    parser.add_argument("--cosine_anneal", type=str2bool,
                        default=True, help="Use cosine annealing")
    parser.add_argument("--warmup_end", type=int, default=0,
                        help="When to end linear warmup")
    parser.add_argument(
        "--lr_patience", type=int, default=1000000, help="Patience before decaying lr"
    )
    parser.add_argument("--reduce_factor", type=float,
                        default=1.0, help="Factor to decay lr")
    parser.add_argument("--p_dropout", type=float,
                        default=0.1, help="Probability of dropout")
    parser.add_argument("--weight_decay", type=float,
                        default=0.05, help="Weight decay value")
